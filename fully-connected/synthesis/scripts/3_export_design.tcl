...
# Write odb
write_design ${odb_dir}/func.odb

# Write MXDB
write_mxdb ${mxdb_dir}/func.mxdb

# Write verilog
write_verilog ${output_dir}/verilog/func.syn.v

# Write SDC
write_sdc ${output_dir}/constraints/func.oasys.sdc

# save_upf
save_upf ${output_dir}/constraints/func.oasys.upf

# Write Floorplan (DEF)
write_def -floorplan ${output_dir}/floorplan/func.def
